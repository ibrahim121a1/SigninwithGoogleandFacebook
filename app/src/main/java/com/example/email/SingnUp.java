...
public class SingnUp extends AppCompatActivity {
                ...
                if (objectFirebaseauth!=null)
                {
                    ...
                    objectFirebaseauth.createUserWithEmailAndPassword(emailET.getText().toString(),passwordET.getText()
                        ...
                        public void onSuccess(AuthResult authResult) {
                            ...
                            {
                                objectprogressbar.setVisibility(View.INVISIBLE);
                                Toast.makeText(SingnUp.this,
                                        "Success to signup", Toast.LENGTH_SHORT).show();
                                signupbtn.setEnabled(true);
                                objectFirebaseauth.signOut();
                                startActivity(new Intent(SingnUp.this,MainActivity.class));
                            }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(SingnUp.this, "Fail to sign up", Toast.LENGTH_SHORT).show();
                            signupbtn.setEnabled(true);
    ...
    private void checkifuserexsist()
    {
                ...
                objectFirebaseauth.fetchSignInMethodsForEmail(emailET.getText()
                    ...
                    public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                        ...
                        else
                        {
                            objectprogressbar.setVisibility(View.INVISIBLE);
                            signupbtn.setEnabled(true);
                            Toast.makeText(SingnUp.this, "Already have an Account", Toast.LENGTH_SHORT).show();
                        }
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        signupbtn.setEnabled(true);
                        objectprogressbar.setVisibility(View.INVISIBLE);
                        Toast.makeText(SingnUp.this, "Fail to check user exsist", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            else if (emailET.getText().toString().isEmpty())
        ...
        {
            Toast.makeText(this, "Check if user Exsist"+e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}
